...
La regresión logística modela la probabilidad de presencia mediante
...
::: {.fragment}
De esta manera, cada especie obtiene su propia descripción estadística de su nicho ecológico.
:::
...
::: {.fragment}
Una ventaja importante de este enfoque es que la variable respuesta es binaria, es decir $Y \in \{0,1\}$
:::

<br>

::: {.fragment}
Por lo tanto, las probabilidades estimadas pueden transformarse en predicciones de presencia o ausencia mediante un umbral.
:::
